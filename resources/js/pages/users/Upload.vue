  ...
  <div class="card card-border border-danger">
    <div class="card-body">
      ...
      <form @submit.prevent="handleSubmit" action="" method="POST">
        ...
        <div class="form-group mb-3">
          <img :src="previewImage" alt="image" class="img-thumbnail profile" :style="{ width: '150px' }" id="image"
            name="image">
        </div>

        <div class="form-group mb-3">
          <label for="image">Image</label>
          <input type="file" class="form-control form-control-sm" id="image" placeholder="png or jpg" @change="upload"
